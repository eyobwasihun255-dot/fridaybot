    ...
    : "-"}
            ...
            {displayedCalledNumbers.length >= 3 && (
              <div className="flex flex-row gap-1">
                ...
                <div className={`w-6 h-6 rounded-full flex items-center justify-center text-xxs font-bold shadow bg-gradient-to-br ${getPartitionColor(displayedCalledNumbers[displayedCalledNumbers.length - 3]!)}`}>
